  ...
  const RoomSelect = function(req, res) {
      ...
      if (usrId != null )
      {
       ...
       'where a.comp_cd = :arg2';
        ...
        sequelize.query(strQuery, {replacements:{arg1:usrId, arg2:compCd}
  ...
  const RoomInfoSave = function(req, res) {
    ...
    else
    {
      ...
      .then(result => {
        ...
        //신규 룸정보 등록
        DT_ROOM.create({COMP_CD: req.body.comp_cd
          , ROOM_ID : roomId
          , ROOM_NAME : req.body.room_name
          , SEQ : seq
          , LEVEL : req.body.level
  ...
  const UserRoomSave = function(req, res) {
    ...
    DT_USRM.findAll({
      ...
      if ( results != null && results.length > 0 )
      {
        ...
        DT_USRM.create({COMP_CD: req.body.comp_cd
          , ROOM_ID : req.body.room_id
          , USR_ID : req.body.usr_id
          , SUC_YN : req.body.suc_yn
          , EXC_TIME : req.body.exc_time
  ...
  const UserFavCompSave = function(req, res) {
    ...
    DT_FAVT.findAll({
      ...
      if ( results != null && results.length > 0 )
      {
        ...
        DT_FAVT.create({COMP_CD: req.body.comp_cd
          , USR_ID : req.body.usr_id
          , FAV_YN : req.body.fav_yn
